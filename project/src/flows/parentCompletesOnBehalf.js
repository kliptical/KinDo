...
/**
 * Flow: Parent Completes Task on Child's Behalf (SPEC §8.6)
 *
 * Orchestrates the full parent-on-behalf completion sequence:
 ...
 * @param {string} args.parentId              - userId of the parent acting on behalf of the child
 ...
 */
export async function parentCompletesOnBehalf({
  stateAdapter,
  ...
  const updated = completionProcessor(instance, parentId, 'parent', currentTime);
